...
import 'package:untitled/utils/widgets/ThickContanier.dart';
      ...
      child: Container(
        ...
        child: Column(
          children: [
                ...
                children: [
                  Row(
                    children: [
                     ...
                     Thickcontanier(isColor: true),
                      Expanded(child : Container()),
                      Text(ticket['to']['code'], style: Styles.headLineStyle3.copyWith(color: isColor==null? Colors.white :Color(0xFF8ACCF7),))
                    ],
                  ),
                  const Gap(3),
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: AppLayout.getWidth(100),child: Text(ticket['from']['name'],textAlign:TextAlign.end,style: Styles.headLineStyle4.copyWith(color: Colors.white),),
            ...
            /* "Doing for orage part of the conatinaer*/
            Container(
            ...
            /* This Container showing next part of the card ORANGE CARD*/
            Container(
              decoration: BoxDecoration(
